...
require("config.error-handling-config")
...
local menu = require("config.menu-config")
menu:init()
...
diskwidget:set_image(os.getenv("HOME") .. "/.config/awesome/du.png")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ env.modkey,           }, "Escape", awful.tag.history.restore,
    ...
    awful.key({ env.modkey,           }, "w", function () mymainmenu:show() end,
    ...
    -- Standard program
    awful.key({ env.modkey,           }, "Return", function () awful.spawn(terminal) end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ env.modkey, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ env.modkey, "Shift"   }, "q", awesome.quit,
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ env.modkey, "Shift"   }, "c",      function (c) c:kill()                         end,
...
clientbuttons = awful.util.table.join(
    ...
    awful.button({ env.modkey }, 1, awful.mouse.client.move),
    awful.button({ env.modkey }, 3, awful.mouse.client.resize))
